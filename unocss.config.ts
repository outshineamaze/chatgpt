...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'dialog-submit-btn': 'inline-fcc gap-1 m-1 text-base bg-slate/20 px-2 py-1 rounded-md transition-colors cursor-pointer hover:bg-slate/50',
  }]
})
